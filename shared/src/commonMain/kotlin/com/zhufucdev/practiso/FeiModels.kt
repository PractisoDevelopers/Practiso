...
data object JinaV2SmallEn : MlModel(
    ...
    features = setOf(
        LanguageInput.of(Language.English),
...
data object JinaV2EnZh : MlModel(
    ...
    features = setOf(
        LanguageInput.of(Language.English, Language.Chinese),
...
data object JinaV2EnEs : MlModel(
    ...
    features = setOf(
        LanguageInput.of(Language.English, Language.Spanish),
        EmbeddingOutput(MetricKind.Cos, 768u)
    )
)
...
data object JinaV2EnDe : MlModel(
    ...
    features = setOf(
        LanguageInput.of(Language.English, Language.German),
        EmbeddingOutput(MetricKind.Cos, 768u)
    )
)
